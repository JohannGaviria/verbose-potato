...
def _build_value(**overrides: Any) -> MemberLoanCacheValueVO:
    data = {**_DEFAULTS, **overrides}
    return MemberLoanCacheValueVO(**data)


class TestMemberLoanCacheValueVO:
    ...
    def test_should_rebuild_value_when_from_dict_is_called(self) -> None:
        ...
        rebuilt = MemberLoanCacheValueVO.from_dict(value.to_dict())
