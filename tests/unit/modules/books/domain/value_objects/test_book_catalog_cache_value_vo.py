...
def _build_value(**overrides: Any) -> BookCatalogCacheValueVO:
    data = {**_DEFAULTS, **overrides}
    return BookCatalogCacheValueVO(**data)


class TestBookCatalogCacheValueVO:
    ...
    def test_should_rebuild_value_when_from_dict_is_called(self) -> None:
        ...
        rebuilt = BookCatalogCacheValueVO.from_dict(value.to_dict())
