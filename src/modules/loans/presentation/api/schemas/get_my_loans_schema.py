"""This module contains the get my loans schema."""
...
class GetMyLoansItemResponseSchema(BaseModel):
    """Response schema for a single loan within the member loans.
    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                ...
                "updated_at": "2026-08-31 18:59:40.152699+00:00",
            }
        }
    }


class GetMyLoansResponseSchema(BaseModel):
    """Response schema for the paginated member loans.

    Attributes:
        items (list[GetMyLoansItemResponseSchema]): The loans for the current page.
    ...
    items: list[GetMyLoansItemResponseSchema]
    total: int
    page: int
    page_size: int
    total_pages: int
